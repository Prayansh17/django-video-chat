...
function createVideo(peerUsername) {
    ...
    // videoContainer.style.innerWidth = '80%';
    videoContainer.style.gridTemplateRows = '400px 400px';
    console.log(x);
    if(x<800){
        // videoContainer.style.gridTemplateColumns =  'auto';
        videoContainer.style.gridTemplateRows = '220px 220px';
        // videoContainer.style.height = '60% !important';
